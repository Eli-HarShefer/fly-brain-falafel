...
const SCRIPT = [
  [12, 'זה מוח אמיתי של זבוב פירות, ונתתי לו לשחק מלך הפלאפל. '
    + 'שלושה מהחלונות פה הם מהמחקר עצמו, והרביעי הוא המודל שאני הרצתי עליו.'],
  [12, 'וככה מיפו אותו. חתכו מוח של זבוב לאלפי פרוסות, '
    + 'כל אחת דקה פי אלף משערה, וצילמו כל פרוסה במיקרוסקופ אלקטרונים.'],
  [10, 'וזאת תמונה אמיתית מתוך המחקר. כל עיגול קטן פה הוא חתך של סיב עצבי אחד, '
    + 'וצריך לעקוב אחרי כל אחד מהם דרך כל הפרוסות.'],
  [13, 'מוח אחד יצא עשרים ואחד מיליון תמונות. '
    + 'גוגל בנתה רשת נוירונים שעוקבת אחרי כל סיב לבד, '
    + 'ואחריה מאתיים שמונים ושבעה חוקרים ומתנדבים מכל העולם עברו על זה ביד. '
    + 'שלושים ושלוש שנות אדם.'],
  [7, 'מאלה מרתי מפרינסטון אמרה שאין שום קונקטום מלא אחר של מוח, '
    + 'לשום חיה בוגרת במורכבות הזאת.'],
  [8, 'מתוך המפה הזאת לקחתי מעגל אחד, '
    + 'בדיוק את זה שאחראי לראות משהו ולזוז אליו.'],
